...
def index(request):
    ...
    most_fresh_posts = Post.objects.order_by('-published_at')[:5].fetch_author_and_tags_witn_comments_count()
...
def tag_filter(request, tag_title):
    ...
    related_posts = tag.posts.all()[:20].fetch_author_and_tags_witn_comments_count()
